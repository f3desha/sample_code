<!--You can start build your 'state' layout here.-->
...
<div class="new_find_catalog">
	...
	<div class="populars_cars_block">
		<div class="catalog_container">
			...
			<?php
				echo \common\components\F3deshaHelpers::UniversalArrayLinkVisualizer($seocatalog->wrapInUALVDataProviderForStates());
			?>
		</div>
	</div>
</div>
