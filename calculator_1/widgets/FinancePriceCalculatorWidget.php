...
/**
 * Class FinancePriceCalculatorWidget
 * @package common\components\calculator\widgets
 *
 * @property string|mixed $calculator
 * @property string|mixed $tabName
 */
class FinancePriceCalculatorWidget extends PriceCalculatorWidget implements CalculatorWidget
{
    ...
    /**
     * FinancePriceCalculatorWidget constructor.
     * @param array $config
     */
    ...
    public function getCalculator(){
		...
		$template_output .= '<div>Discount: {{fields.'.self::CALCULATOR_INDEX.'.'.Calculator::OPERAND_INDEX_DISCOUNT.'.value}}</div>';
		$template_output .= '<div>Rebates: {{fields.'.self::CALCULATOR_INDEX.'.'.Calculator::OPERAND_INDEX_TOTAL_REBATES.'.value}}</div>';
